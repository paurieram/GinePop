...
class AddMoreFieldsToUsersTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('categories')->insert([
            ['name' => 'bicis', 'image' => '/img/categories/categoria.png', 'created_at' => '2022-01-01'],
            ['name' => 'motxiles', 'image' => '/img/categories/categoria.png', 'created_at' => '2022-01-01'],
            ['name' => 'roba', 'image' => '/img/categories/categoria.png', 'created_at' => '2022-01-01'],
            ['name' => 'sabates', 'image' => '/img/categories/categoria.png', 'created_at' => '2022-01-01']
        ]);
        DB::table('items')->insert([
            ...
            ['name' => 'Mochila impermeable táctica', 'price' => 26.5,'description' => 'Mochila impermeable capacidad de 15L, ideal para acampada, caza, pesca, senderismo o el uso que quieras darle, es amplia y esta completamente nueva, la tengo en ambos colores Hago envíos a toda España y los gastos corren de mi cuenta (concretamos por WhatsApp)Mochila impermeable capacidad de 15L, ideal para acampada, caza, pesca, senderismo o el uso que quieras darle, es amplia y esta completamente nueva, la tengo en ambos colores Hago envíos a toda España y los gastos corren de mi cuenta (concretamos por WhatsApp)','location' => 'Madrid','id_category' => '1','id_seller'=>'1','expiration_date'=>'2024-05-26'],
            ['name' => 'Mochila bullpadel', 'price' => 25,'description' => 'A estrenar','location' => 'Madrid','id_category' => '1','id_seller'=>'1','expiration_date'=>'2024-05-26'],
            ['name' => 'NUEVO Mochila Bullpadel', 'price' => 25,'description' => 'A estrenar','location' => 'Madrid','id_category' => '1','id_seller'=>'1','expiration_date'=>'2024-05-26'],
            ['name' => 'Mochila montaña', 'price' => 5,'description' => 'Mochila APRENAZ 30 litros.','location' => 'Madrid','id_category' => '1','id_seller'=>'1','expiration_date'=>'2024-05-26'],
            ['name' => 'Mochila montaña', 'price' => 10,'description' => 'Mochila Quechua FORCLAZ 30 litros con cubierta para la lluvia','location' => 'Madrid','id_category' => '1','id_seller'=>'1','expiration_date'=>'2024-05-26'],
            ['name' => 'Roba d`esport Maristes (varis)', 'price' => 8,'description' => 'Ropa de deporte uniforme Maristas. Tengo disponibles los siguientes artículos: - pantalón largo chándal T-8: 8 euros. - sudadera chándal T-4: 8 euros. - camiseta manga corta T-8: 5 euros. - pantalón corto T-6: 4 euros. - camiseta manga larga T-8 y T-10: 6 euros','location' => 'Rubí','id_category' => '1','id_seller'=>'1','expiration_date'=>'2024-05-26'],
            ['name' => 'Roba nàstic talla 140', 'price' => 25,'description' => 'Roba nàstic , samarreta d entrenament, polo de passeig i jaqueta xandall, talla 140 benj 1 i 2 any aprox.','location' => 'L`Ametlla de Merola','id_category' => '1','id_seller'=>'1','expiration_date'=>'2024-05-26'],
            ['name' => 'Chaqueta polar térmica MAMMUT', 'price' => 65,'description' => 'Chaqueta polar térmica MAMMUT ideal para deportes de montaña. Talla S Buen estado. Medidas Pecho 100 cm - largo 64 cm Se entrega en Barcelona (zona Sagrada Familia) Envío solo por Correos certificado, precio no incluido (8€) Pago BIZUM o transferencia Bancaria la caixa. No se envio por WALLAPOP No WALLAPAY No contrarembolso No Paypal No intercambios Gbp forro Salomón the north face escalada travesía roba01','location' => 'Barcelona','id_category' => '1', 'id_seller'=>'1','expiration_date'=>'2024-05-26'],
            ['name' => 'Roba Esportiva', 'price' => 15,'description' => 'Pantaló malla elàstica Marca: Nike Talla L','location' => 'L`Hospitalet de Llobregat','id_category' => '1','id_seller'=>'1','expiration_date'=>'2024-05-26'],
            ['name' => 'Chaqueta deporte 12/A', 'price' => 8,'description' => 'Chaqueta deporte 12/A, con capucha almacenada y totalmente forrada. Bolsillos laterales con cremalleras. Talla 6/7 que equivale a 10-12 años. Tejido de calidad. Hago envíos. Hago packs por si te interesan varias cosas del perfil. Chico niño noi xiquet ropa roba moda sport esport deporte','location' => 'Rubí','id_category' => '1', 'id_seller'=>'1','expiration_date'=>'2024-05-26'],
            ['name' => 'Roba esportiva', 'price' => 18,'description' => 'Jersei Adidas maniga curta i 2 pantalons . per noi noia de 11 a 14 anys, tot 18€','location' => 'Tordera','id_category' => '1','id_seller'=>'1','expiration_date'=>'2024-05-26'],
            ['name' => 'Zapatillas Adidas', 'price' => 25,'description' => 'Zapatillas Adidas. Numero 35. Usadas en contadas ocasiones. En perfecto estado. #Adidas, cazado, calçat, zapatos, sabates, zapatillas, deportivas, deporte, bambas, ropa, roba, moda, niña, infantil#','location' => 'Vinyols i els Arcs', 'id_category' => '1', 'id_seller'=>'1','expiration_date'=>'2024-05-26'],
            ['name' => 'Zapatillas de golf Skechers', 'price' => 45,'description' => 'Zapatillas de golf Skechers, color negro, talla 44 eur, estado muy bueno, ideal primavera verano','location' => 'Madrid', 'id_category' => '1','id_seller'=>'1','expiration_date'=>'2024-05-26'],
            ...
            ['name' => 'Zapatillas Adidas mujer talla 38 nuevas', 'price' => 35,'description' => 'Nuevas entrega en madrid estación de metro','location' => 'Madrid', 'id_category' => '1','id_seller'=>'1','expiration_date'=>'2024-05-26'],
            ['name' => 'Zapatillas talla 40', 'price' => 25,'description' => 'Zapatillas talla 40','location' => 'Madrid', 'id_category' => '1','id_seller'=>'1','expiration_date'=>'2024-05-26'],
